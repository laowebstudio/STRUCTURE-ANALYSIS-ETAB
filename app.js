...
function building3dCenterV130(){
  ...
  wrap.innerHTML=`<div class="eng-card v130-building-card"><div class="section-db-head"><div><h2>3D Building Generator — V1.30.1 Fix</h2><small>Independent 3D workspace • generates only state.model3d • 2D model is not modified</small></div><button class="ml-close">×</button></div>
