...
function loadManagerV118(){
 ...
 wrap.innerHTML=`<div class="eng-card v118-card"><div class="section-db-head"><div><h2>☷ Load Assignment Manager — V1.18.1 Fix</h2><small>Review, filter, copy, assign and clear loads without editing Members one-by-one.</small></div><button class="ml-close" id="v118Close">×</button></div>
...
function loadCenterV115(){
 ...
 wrap.innerHTML=`<div class="eng-card load-center-card"><div class="section-db-head"><div><h2>⬇ Load Center — V1.18.1 Fix</h2><small>Automatic self weight, generated-load management and combination templates.</small></div><button class="ml-close" id="lc15Close">×</button></div>
...
updateEngineeringSelectors();migrateLoads();resize();updateUI();renderResults();updateResultModeButtons();setResultView('model',false);setTool('select');syncScaleUI();initResultsWorkspaceV113();toast('V1.18.1 Fix — Load Manager search/filter ready');
})();
