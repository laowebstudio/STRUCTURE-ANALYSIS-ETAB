...
// ===== V1.35 — Rigid Floor Diaphragm (3D constraint layer; V1.34 results protected when OFF) =====
...
function diaphragmCenterV135(){
 ...
 wrap.querySelector('#v135Apply').onclick=()=>{d.enabled=wrap.querySelector('#v135Enable').checked;d.stories={};wrap.querySelectorAll('[data-v135-story]').forEach(x=>d.stories[x.dataset.v135Story]=x.checked);m3.results=null;if(typeof integrated3dRefreshV128==='function')integrated3dRefreshV128(false);close();toast(`V1.35 Rigid Diaphragm ${d.enabled?'enabled':'disabled'}`)};
}
