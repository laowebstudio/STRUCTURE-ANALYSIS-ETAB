...
function frame3dCenterV127(){
 ...
 document.body.appendChild(wrap);wrap.querySelector('.ml-close').onclick=()=>wrap.remove();
...
updateEngineeringSelectors();migrateLoads();resize();updateUI();renderResults();updateResultModeButtons();setResultView('model',false);setTool('select');syncScaleUI();initResultsWorkspaceV113();toast('V1.28 — Integrated 3D Workspace • Phase 2 solver • 2D engine preserved');
})();
