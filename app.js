...
// ===== V1.33.1 Fix — Story Governing Node Locate (post-processing only; V1.32 solver protected) =====
...
updateEngineeringSelectors();migrateLoads();resize();updateUI();renderResults();updateResultModeButtons();setResultView('model',false);setTool('select');syncScaleUI();initResultsWorkspaceV113();toast('V1.33.1 Fix — Story Governing Node Locate • V1.32 solver protected');
})();
